                        ...
                        <CardContent className="space-y-8">
                            ...
                            <div className="space-y-6 p-6 border rounded-lg">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <RadioGroup defaultValue={sponsorshipType} onValueChange={setSponsorshipType} className="flex gap-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input id="name" placeholder="Jane Smith" required value={name} onChange={(e) => setName(e.target.value)} />
                                    </div>
                                    {sponsorshipType === 'corporate' && (
                                         <div className="space-y-2">
                                            <Label htmlFor="org-name">Organization Name</Label>
                                            <Input id="org-name" placeholder="Smith Family Foundation" required />
                                        </div>
                                    )}
                                    <div className="space-y-2">
                                        <Label htmlFor="email">Email Address</Label>
                                        <Input id="email" type="email" placeholder="jane@smithfoundation.org" required />
                                    </div>
                                    <div className="space-y-2">
                            ...
                            <div className="space-y-6 p-6 border rounded-lg">
                                 ...
                                 <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea id="motivation" rows={4} placeholder="We believe in second chances..." />
                                    </div>
                                </div>
                            </div>
